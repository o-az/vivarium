  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className='fixed left-4 top-16 bottom-4 w-80 rounded-2xl overflow-hidden flex flex-col z-50'
        style={{ zIndex: 50, background: 'rgba(8, 12, 18, 0.95)', border: '1px solid rgba(255,255,255,0.1)' }}>
        <div
          className='p-5 pb-3'
          style={{
            ...
            <div className='space-y-2'>
              {isActive && (
                <>
                  <button
                    onClick={onFeed}
                    className='w-full py-2 px-4 rounded-lg glass text-sm font-display font-medium transition-all hover:scale-[1.02] active:scale-[0.98]'
                    style={{
                      borderColor: hslStrA(hue, sat, 50, 0.3),
                  ...
                  <button
                    onClick={onWork}
                    className='w-full py-2 px-4 rounded-lg glass text-sm font-display font-medium text-amber transition-all hover:scale-[1.02] active:scale-[0.98]'>
                    ⚡ Work — Earn tokens
                  </button>
                    ...
                    {(['strength', 'efficiency', 'creativity', 'resilience', 'speed'] as const)
                      ...
                      .map(trait => (
                        <button
                          ...
                          className='py-1.5 px-2 rounded-lg glass text-xs font-body text-white/60 hover:text-white/90 transition-all hover:scale-[1.02] active:scale-[0.98]'>
              ...
              {isHibernating && (
                <button
                  onClick={onRevive}
                  className='w-full py-2 px-4 rounded-lg glass text-sm font-display font-medium text-blue-300 transition-all hover:scale-[1.02] active:scale-[0.98]'
